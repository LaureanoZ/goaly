...
<template>
    <section class="container-account row p-5 full-height">
        ...
        <form action="#" method="post" @submit.prevent="processRegister">
            <AppLabel class="visually-hidden" for="email">Email</AppLabel>
            <div class="field-account">
                ...
                <AppInput class="input-account" type="email" name="email" id="email" v-model="dataAuth.email" placeholder = "Escribe tu Email" />
            </div>
            <AppLabel class="visually-hidden" for="password">Contraseña</AppLabel>
